...
// ─── Rainbow Themes ───────────────────────────────────────────────────────
export const redLight = createTheme(
  false,
  {
    base: '#B3261E',
    on: '#FFFFFF',
...
export const redDark = createTheme(
  true,
  {
    base: '#F2B8B5',
    on: '#601410',
...
export const orangeLight = createTheme(
  false,
  {
    base: '#984816',
    on: '#FFFFFF',
...
export const yellowLight = createTheme(
  false,
  {
    base: '#6C5E0F',
    on: '#FFFFFF',
...
export const indigoLight = createTheme(
  false,
  {
    base: '#4858A9',
    on: '#FFFFFF',
...
export const violetLight = createTheme(
  false,
  {
    base: '#6C4EA0',
    on: '#FFFFFF',
...
export const violetDark = createTheme(
  true,
  {
    base: '#D2BCFD',
    on: '#3D1C6F',
...
export const pinkDark = createTheme(
  true,
  {
    base: '#FFAFD0',
    on: '#5E1139',
...
export const tealDark = createTheme(
  true,
  {
    base: '#4CD9E4',
    on: '#00363A',
...
export const amberLight = createTheme(
  false,
  {
    base: '#885200',
    on: '#FFFFFF',
...
export const amberDark = createTheme(
  true,
  {
    base: '#FFB86A',
    on: '#482A00',
...
export const mintLight = createTheme(
  false,
  {
    base: '#006C4C',
    on: '#FFFFFF',
...
export const mintDark = createTheme(
  true,
  {
    base: '#55DCAE',
    on: '#003826',
...
export const coralDark = createTheme(
  true,
  {
    base: '#FFB4AC',
    on: '#601013',
...
export const plumLight = createTheme(
  false,
  {
    base: '#85255F',
    on: '#FFFFFF',
...
export const plumDark = createTheme(
  true,
  {
    base: '#FFAFD5',
    on: '#500036',
...
export const slateLight = createTheme(
  false,
  {
    base: '#485E71',
    on: '#FFFFFF',
...
export const slateDark = createTheme(
  true,
  {
    base: '#AAC7E2',
    on: '#173042',
...
// ─── Base Grey ────────────────────────────────────────────────────────────
export const greyLight = createTheme(
  false,
  {
    base: '#212121',
    on: '#FAFAFA',
...
export const greyDark = createTheme(
  true,
  {
    base: '#FAFAFA',
    on: '#212121',
